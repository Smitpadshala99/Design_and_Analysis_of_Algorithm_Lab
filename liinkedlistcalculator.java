...
public class liinkedlistcalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter a String you want to store in linked list 1");
        String num1 = sc.next();
        System.out.println("Enter a String you want to store in linked list 2");
        String num2 = sc.next();
        String s1;
        if(num1.charAt(0) == '-'){
